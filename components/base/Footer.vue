<template>
  <div class="bg-gray-200">
    <footer class="px-8 md:px-16 text-gray-700 body-font">
      <div
        class="px-5 py-24 mx-auto flex md:items-center lg:items-start md:flex-row md:flex-no-wrap flex-wrap flex-col"
      >
        <div
