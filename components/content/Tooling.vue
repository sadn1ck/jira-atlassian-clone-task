<template>
  <div>
    <section class="py-12 px-8 lg:px-32 text-center">
      <div class="pb-8">
      ...
      <div class="flex flex-wrap items-center justify-center -mx-8 mb-12">
        <div class="lg:w-1/3 px-8 mb-8 lg:mb-0">
          ...
          <p class="text-gray-800 leading-relaxed">
            Jira Software invested in GDPR and Privacy Shield to ensure all data
        ...
        <div class="lg:w-1/3 px-8 mb-8 lg:mb-0">
          ...
          <p class="text-gray-800 leading-relaxed">
            Jira Software leverages encryption in transit and at rest to
        ...
        <div class="lg:w-1/3 px-8 mb-8 lg:mb-0">
          ...
          <p class="text-gray-800 leading-relaxed">
            Verify Jira Software's security with SOC2, SOC3, ISO 27001, ISO
            27018, PCI DSS, and more.
          </p>
        </div>
      </div>
    ...
    <div
      class="container mx-auto flex px-5 py-8 lg:py-24 md:flex-row-reverse flex-col items-center"
    >
      <div class="lg:flex-grow md:w-1/2 w-5/6 mb-10 md:mb-0">
        <img
          class="object-cover object-center rounded shadow-2xl"
          alt="hero"
          src="https://wac-cdn.atlassian.com/dam/jcr:ed5a5006-c1e0-4c56-b22c-4ab8533fd29d/plan-track.png?cdnVersion=1280"
        />
      </div>
      <div
        class="lg:max-w-lg lg:w-full md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left items-center text-center"
      >
        <h1
          class="title-font sm:text-4xl text-2l mb-4 font-bold text-gray-900"
        >
        ...
        <button class="text-indigo-600 border border-indigo-600 p-5 hover:bg-indigo-600 hover:text-white transition duration-500 rounded">
